        ...
        <div className='px-4'>
            ...
            <div className='lg:flex items-center mt-12 gap-10 px-5'>
                <form class="flex items-center mt-5 lg:mt-0 ">
                    ...
                    <button type="button" class="bg-textHeading text-white  hover:bg-accent hover:text-black ease-in duration-300 rounded-r-lg ml-[-43px] w-40 h-12">Apply Coupon </button>
                </form>
            </div>
